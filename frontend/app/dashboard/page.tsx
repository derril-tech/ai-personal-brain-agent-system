      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Your personal brain agent system is ready to help you accomplish your goals.
          </p>
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Command Console - Takes up 2/3 of the space */}
        <div className="lg:col-span-2">
          <CommandConsole />
        </div>

        {/* Goals Overview - Takes up 1/3 of the space */}
